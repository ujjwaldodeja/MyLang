prints sequence of Gauss series, followed by end result (printed twice)
...
### Spril instructions:
```
  0: Load (ImmValue 8) regA                   --Assignment to n
  1: Store regA (DirAddr 0)                   
  2: Load (ImmValue 1) regA                   --Assignment to i
  3: Store regA (DirAddr 2)                   
  4: Load (ImmValue 0) regA                   --Assignment to sum
  5: Store regA (DirAddr 1)                   
  6: Load (DirAddr 0) regB                    --(Loading var n) // While condition check
  7: Load (DirAddr 2) regA                    --(Loading var i)
  8: Compute LtE regA regB regA               
  9: Compute Equal regA reg0 regA             
 10: Branch regA (Abs 22)                     
 11: Load (DirAddr 2) regB                    --(Loading var i) // Assignment to sum // While body
 12: Load (DirAddr 1) regA                    --(Loading var sum)
 13: Compute Add regA regB regA               
 14: Store regA (DirAddr 1)                   
 15: Load (ImmValue 1) regB                   --Assignment to i
 16: Load (DirAddr 2) regA                    --(Loading var i)
 17: Compute Add regA regB regA               
 18: Store regA (DirAddr 2)                   
 19: Load (DirAddr 1) regA                    --(Loading var sum) // Print
 20: WriteInstr regA numberIO                 
 21: Jump (Abs 6)                             
 22: Load (DirAddr 1) regA                    --(Loading var sum) // Print
 23: WriteInstr regA numberIO                 
 24: EndProg                                  
